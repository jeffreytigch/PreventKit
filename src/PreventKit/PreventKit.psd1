@{
    ...
    PrivateData          = @{
        PSData = @{
            ...
            ReleaseNotes               = 'Issue 1: Catalogue retrieval and validation (read side of a Run). Issue 2: Desired state and WhatIf report. Issue 3: TABL read and provenance classification. Issue 5: CNI projection, read and provenance classification.'
        }
    }
}
